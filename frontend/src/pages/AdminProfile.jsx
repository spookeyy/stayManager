...
function AdminProfile() {
  ...
  const openUpdateForm = () => {
    ...
    const updateProfileFormContainer =
      updateProfileWindow.document.getElementById("update-profile-form");
    updateProfileFormContainer.innerHTML = `
      <div>
        ...
        <script>
          ...
          document.getElementById('update-profile-root').innerHTML = '${UpdateProfileForm.toString()}'.replace('({ onClose, currentUser })', `(
      { onClose: () => window.close(), currentUser }
    )`);
        </script>
      </div>
    `;
